        ...
        if(prevProps.data !== this.props.data) {
            if (this.props.data !== null) {
                this.setState({
                    ...
                    currency: this.props.data.generalInformation.currency ? this.props.data.generalInformation.currency : "No Data Available",
            ...
            <div className="countryinfo">
                ...
                <div className="country-column2">
                    <div className="info-column">
                        <div className="info-row">Most Common Language</div>
                        <div className="info-row">Currency</div>
                    ...
                    <div className="info-results-column">
                        ...
                        <div className="info-results-row">{this.state.currency}</div>{/*Languages*/}
