...
for c_name in country_names:
  ...
  new_country['generalInformation']['currency'] = None
  new_country['generalInformation']['languages'] = None
  if data.alpha_2 in iso_country_info:
    # get currency
    currency_code = iso_country_info[data.alpha_2]['CurrencyCode']
    if currency_code in iso_currency_codes:
      currency_name = iso_currency_codes[currency_code]['Currency']
      new_country['generalInformation']['currency'] = currency_name

    # get languages
    languages = iso_country_info[data.alpha_2]['Languages'].split(',')
    formatted_languages = []
    ...
    new_country['generalInformation']['languages'] = formatted_languages

    # get continent
    continent_abbr = iso_country_info[data.alpha_2]['Continent']
